...
class RegrowthPolicyGradient:
    ...
    def _save_checkpoint(self, epoch, best_reward, best_allocation, best_regrow_indices):
        ...
        checkpoint_path = os.path.join(self.checkpoint_dir, f'saliency_rl_checkpoint_epoch_{epoch+1}.pth')
    ...
    def _save_best_allocation(self, epoch, best_reward, best_allocation, best_regrow_indices):
        ...
        os.makedirs(self.checkpoint_dir, exist_ok=True)
        best_path = os.path.join(self.checkpoint_dir, f'best_saliency_allocation_{self._model_name}.pth')
...
def main():
    ...
    # Final finetuning
    final_save_path = os.path.join(args.save_dir, f'final_model_{args.m_name}.pth')
