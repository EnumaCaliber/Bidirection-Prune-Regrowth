...
# parser.add_argument('--model_path', type=str, default='best_grown_model.pth')
parser.add_argument('--model_path', type=str, default='rl_checkpoints_1/vgg16/iterative/iter_3/best_grown_model.pth')
