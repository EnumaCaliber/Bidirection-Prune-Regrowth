...
class CifarResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        out = self.layer2(out)
        out = self.layer3(out)
        out = F.avg_pool2d(out, 8)  # because CIFAR-10 is 32x32
        out = out.view(out.size(0), -1)
...
def ResNet20():
    return CifarResNet(BasicBlock, num_blocks=3)

def ResNet32():
    return CifarResNet(BasicBlock, num_blocks=5)

def ResNet44():
    return CifarResNet(BasicBlock, num_blocks=7)

def ResNet56():
    return CifarResNet(BasicBlock, num_blocks=9)
