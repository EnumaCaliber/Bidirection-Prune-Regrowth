"""
Baseline 4: Proportional (1-SSIM) allocation + Saliency weight selection
...
def main():
    ...
    parser.add_argument('--save_dir',        type=str,   default='./baselines/proportional_saliency')
    ...
    print(f"[proportional_saliency] Device={device}  seed={args.seed}")
    ...
    run = None if args.no_wandb else wandb.init(
        ...
        name=f"proportional_saliency_{args.m_name}_s{args.seed}",
        config=vars(args))
